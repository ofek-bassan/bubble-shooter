...
public class Constants {
    ...
    public static final int BORDER_X = 719; // -----719 for laptop or school || 890 for 1080p || 742 for school-----
    public static final int BORDER_WIDTH_DRAW = 95;// -----95 for laptop or school || 130 for 1080p || 100 for school-----
    public static final int BORDER_WIDTH = 720; // -----720 for laptop or school || 920 for 1080p-----
    public static final int RIVAL_BORDER_WIDTH = 820; // -----820 for laptop or school || 1010 for 1080p-----
    public static final int RIVAL_X = FIELD_SIZE_X / 2+SPRITE_R*8; // ------ 8 for laptop || 10 for 1080p-----
    public static final int BALL_WIDTH = 54; // -----54 for laptop 56 to school || 68 for 1080p-----
    static {
        try {
